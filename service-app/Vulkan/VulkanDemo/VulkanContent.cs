...
unsafe class VulkanContent : IDisposable
{
    ...
    private Mutex _stageMutex = new();
    private int _stageVertexBufferSize = 0;
    private Silk.NET.Vulkan.Buffer _stageVertexBuffer;
    private DeviceMemory _stageVertexBufferMemory;
    private int _stageIndexBufferSize = 0;
    ...
    public void UpdateStage(List<TriangleBuffer> models)
    {
        ...
        try
        {
            ...
            if (points.Length != _stageVertexBufferSize)
            {
                ...
                VulkanBufferHelper.AllocateBuffer<Vertex>(_context, BufferUsageFlags.VertexBufferBit, out _stageVertexBuffer,
            ...
            if (indices.Length != _stageIndexBufferSize)
            {
                ...
                VulkanBufferHelper.AllocateBuffer<ushort>(_context, BufferUsageFlags.IndexBufferBit, out _stageIndexBuffer,
